# Generated by Django 4.2.1 on 2023-08-04 15:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_mover', models.BooleanField(default=False, verbose_name='mover status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, max_length=50, null=True)),
                ('user', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='mover', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
